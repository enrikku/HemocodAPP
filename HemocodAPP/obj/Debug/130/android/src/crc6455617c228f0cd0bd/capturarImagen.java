...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("HemocodAPP.capturarImagen, HemocodAPP", capturarImagen.class, __md_methods);
	}


	public capturarImagen ()
	{
		super ();
		if (getClass () == capturarImagen.class) {
			mono.android.TypeManager.Activate ("HemocodAPP.capturarImagen, HemocodAPP", "", this, new java.lang.Object[] {  });
		}
	}
